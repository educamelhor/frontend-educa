// features/professores/conselho/FichaAlunoProfessor.jsx
// ============================================================================
// Versão PROFESSOR da Ficha do Estudante.
//
// Governança aplicada:
//  ✅ Exibe dados pessoais do aluno (nome, turma, turno, código, nascimento, sexo)
//  ✅ Abre Relatório Pedagógico (somente leitura, sem Descrição/Registro Interno)
//  ❌ Upload de foto            — OCULTO (professor não gerencia fotos)
//  ❌ Relatório Disciplinar     — OCULTO (exclusivo de direção/coordenação)
//  ❌ Botão Voltar à lista      — não aplicável (uso exclusivo em modal)
//
// Este arquivo é INDEPENDENTE de alunos/FichaAluno.jsx.
  ...
  return (
    <div style={{ fontFamily: "'Inter', 'Segoe UI', sans-serif" }}>
      ...
      <div style={{ background: "#fff", borderRadius: "0 0 16px 16px", padding: "20px 24px 24px" }}>
        ...
        {/* Relatórios — apenas pedagógico (somente leitura) */}
        <div>
          <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#9ca3af", marginBottom: 12 }}>
            RELATÓRIOS
          </div>
          ...
          <div style={{ marginBottom: 12, padding: "8px 12px", background: "#eff6ff", border: "1px solid #bfdbfe", borderRadius: 8, fontSize: 12, color: "#1d4ed8" }}>
            ℹ️ Você tem acesso ao histórico pedagógico em modo somente leitura. Relatórios disciplinares são gerenciados pela coordenação.
          </div>

          {/* Card Relatório Pedagógico */}
          <div
          ...
          >
            ...
            <div style={{ fontSize: 12, color: "rgba(255,255,255,0.7)", marginBottom: 10 }}>
              Histórico de registros pedagógicos do estudante (somente leitura).
            </div>
      ...
      {/* Modal Relatório Pedagógico — versão professor */}
