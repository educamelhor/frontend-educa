...
import GabaritoCorrigir from "./GabaritoCorrigir";
...
const TABS = [
  { id: "gerar", label: "Gerar Gabaritos", icon: IconGerar, badge: "ETAPA 1" },
  ...
  return (
    <div className="gabarito-module">
      ...
      <div className="gab-content" key={activeTab}>
        {activeTab === "gerar" && <GabaritoGerar />}
        {activeTab === "corrigir" && <GabaritoCorrigir />}
