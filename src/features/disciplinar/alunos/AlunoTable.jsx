// src/features/disciplinar/alunos/AlunoTable.jsx
// ⚠️ MÓDULO ISOLADO — cópia local independente do módulo Secretaria
// A única diferença: importa FichaAluno de './FichaAluno' (disciplinar),
// garantindo que o modal de Nova Medida Disciplinar use os componentes do módulo correto.
...
import FichaAluno from "./FichaAluno"; // ✅ isolado: importa do módulo Disciplinar (não do Secretaria)
...
// ════════════════════════════════════════════════════════════════════════
/*
  Componente AlunoTable — Módulo Disciplinar (isolado)
...
export default function AlunoTable({
  ...
  return (
    <div className="overflow-x-auto">
            ...
            >
              ...
              <td className="p-2 border text-center">
                <div className="flex justify-center gap-2">
                  {/* ✅ Ícone de ficha do estudante (abre modal do módulo disciplinar) */}
                  {mostrarFicha && (
                    <button
      ...
      {/* ✅ Modal inline para ficha — usa FichaAluno do módulo Disciplinar */}
      {openFicha && (
