// features/pedagogico/conselho/ModalRegistroConselhoPedagogico.jsx
// ============================================================================
// Modal de REGISTRO de Conselho de Classe — Módulo PEDAGÓGICO (isolado)
//
// Governança:
//  ✅ Direção / Pedagógico pode VISUALIZAR todos os registros do conselho
//  ✅ Direção / Pedagógico pode CRIAR seu próprio registro
//  ✅ Quem registra pode EDITAR e EXCLUIR o próprio registro
//  ✅ Rastreabilidade completa: exclusão preserva rastro (soft-delete com audit)
//  ❌ Não pode editar registros de outros usuários
//
// Isolado do módulo professores. Alterações aqui não afetam ConselhoClasseProfessor.
// ============================================================================
...
export default function ModalRegistroConselhoPedagogico({
  open,
              ...
              {registros.map((reg) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-2 pb-2" style={{ borderBottom: "1px solid rgba(99,179,237,0.1)" }}>
                    ...
                    {/* Editar/Excluir — apenas para quem criou */}
