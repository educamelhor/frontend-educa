...
const MODULOS_TREE = [
  ...
  {
    id: 'disciplinar', label: 'Disciplinar', icon: 'ÔÜû´©Å',
    filhos: [
      { id: 'disciplinar.alunos', label: 'Alunos' },
      { id: 'disciplinar.historico', label: 'Hist├│rico' },
      { id: 'disciplinar.atas', label: 'Atas' },
      { id: 'disciplinar.fo_coletivo', label: 'F.O. Coletivo' },
      { id: 'disciplinar.responsaveis', label: 'Respons├íveis' },
      { id: 'disciplinar.liberacao', label: 'Libera├º├úo' },
      { id: 'disciplinar.metadados', label: 'Metadados' },
      { id: 'disciplinar.equipe', label: 'Gest├úo de Equipe' },
  ...
  },
  {
    ...
    filhos: [
      ...
      { id: 'pedagogico.solicitacoes', label: 'Solicita├º├Áes' },
  ...
  },
  {
    ...
    filhos: [
      ...
      { id: 'monitoramento.visitantes_registrar', label: 'Visitantes ÔÇô Registrar' },
      { id: 'monitoramento.visitantes_historico', label: 'Visitantes ÔÇô Hist├│rico' },
      { id: 'monitoramento.embeddings', label: 'Embeddings ÔÇô Gerar' },
    ]
  },
  {
  ...
  {
    id: 'estudantes', label: 'Estudantes', icon: '­ƒÄÆ',
    filhos: []
  },
];
...
export default function PlataformaModulos() {
  ...
  // ÔöÇÔöÇ Manuten├º├úo Programada ÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ Fetch manuten├º├úo status ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ Load modules for a school ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  const fetchModulos = useCallback(async (id) => {
    ...
    try {
      ...
      setError('N├úo foi poss├¡vel carregar os m├│dulos desta escola.');
  ...
  // ÔöÇÔöÇ Save ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ Copy from another school ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  return (
    <div style={S.page}>
      ...
      <div style={{
        margin: '0 24px 20px', padding: '20px 24px',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
          <span style={{ fontSize: '1.3rem' }}>­ƒøá´©Å</span>
        ...
        {manutData ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: '200px' }}>
              <div style={{ fontSize: '0.75rem', color: '#64748b', marginBottom: '4px' }}>Per├¡odo</div>
              <div style={{ fontSize: '0.9rem', color: '#cbd5e1' }}>
                {new Date(manutData.inicio).toLocaleString('pt-BR', {timeZone:'America/Sao_Paulo'})} ÔåÆ {new Date(manutData.fim).toLocaleString('pt-BR', {timeZone:'America/Sao_Paulo'})}
              </div>
          ...
          <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-end', flexWrap: 'wrap' }}>
            <div style={{ flex: '1 1 180px' }}>
              <label style={{ fontSize: '0.7rem', color: '#64748b', display: 'block', marginBottom: '4px' }}>In├¡cio</label>
              <input type="datetime-local" value={manutInicio} onChange={e => setManutInicio(e.target.value)}
                style={{ width: '100%', padding: '7px 10px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(15,23,42,0.6)', color: '#e2e8f0', fontSize: '0.85rem' }} />
            </div>
            <div style={{ flex: '1 1 180px' }}>
              <label style={{ fontSize: '0.7rem', color: '#64748b', display: 'block', marginBottom: '4px' }}>Fim</label>
              <input type="datetime-local" value={manutFim} onChange={e => setManutFim(e.target.value)}
                style={{ width: '100%', padding: '7px 10px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(15,23,42,0.6)', color: '#e2e8f0', fontSize: '0.85rem' }} />
            </div>
            <div style={{ flex: '2 1 250px' }}>
              <label style={{ fontSize: '0.7rem', color: '#64748b', display: 'block', marginBottom: '4px' }}>Mensagem</label>
              <input type="text" value={manutMsg} onChange={e => setManutMsg(e.target.value)} placeholder="Mensagem para os usu├írios"
                style={{ width: '100%', padding: '7px 10px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(15,23,42,0.6)', color: '#e2e8f0', fontSize: '0.85rem' }} />
            </div>
            <button
        ...
        {manutError && (
          <div style={{ marginTop: '8px', fontSize: '0.8rem', color: '#f87171', background: 'rgba(239,68,68,0.08)', padding: '6px 12px', borderRadius: '8px' }}>
            {manutError}
          </div>
        )}
      </div>
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: 'center', marginBottom: '24px' }}>
              <div style={{ fontSize: '2.5rem', marginBottom: '8px' }}>ÔÜá´©Å</div>
              <h3 style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '8px', marginBottom: '10px', alignItems: 'center' }}>
                <span style={{ fontSize: '0.7rem', color: '#64748b', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Per├¡odo</span>
              </div>
              <div style={{ fontSize: '0.95rem', color: '#fbbf24', fontWeight: 600, marginBottom: '4px' }}>
                ...
                <span style={{ color: '#475569', margin: '0 8px' }}>ÔåÆ</span>
            ...
            <div style={{
              ...
              ÔÜá´©Å Nenhum usu├írio escolar poder├í acessar o sistema durante este per├¡odo. Apenas o CEO continua com acesso.
            </div>
          ...
          {!escolaId && (
            <div style={{
              ...
              <div style={{
                ...
                Escolha uma escola na lista ├á esquerda para configurar quais m├│dulos ela tem acesso.
              </div>
              <div style={{
