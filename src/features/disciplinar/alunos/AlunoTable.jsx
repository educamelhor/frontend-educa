...
// Copia isolada para o modulo Disciplinar — usa FichaAlunoDisciplinar (sem banner pedagogico)
...
import FichaAlunoDisciplinar from "./FichaAlunoDisciplinar"; // ✅ versao local sem banner pedagogico
