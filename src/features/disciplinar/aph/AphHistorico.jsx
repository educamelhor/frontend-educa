...
function ModalDetalhes({ atend, onClose, onEdit }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-start sm:items-center justify-center bg-black/50 p-4 print:p-0 print:bg-white print:block overflow-y-auto">
      <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl flex flex-col sm:my-auto max-h-[92vh] print:max-h-none print:shadow-none print:rounded-none">
