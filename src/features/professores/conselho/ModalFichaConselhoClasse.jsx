...
// ============================================================================
// Ficha do Conselho de Classe — abre via EyeIcon na tabela de alunos.
//
// Regra LGPD: backend retorna foto=null quando consentimento_imagem≠1.
// Se foto=null → exibe iniciais do aluno. Nunca tenta exibir foto sem
// consentimento.
//
// API:
...
export default function ModalFichaConselhoClasse({ open, aluno, turma, onClose }) {
  ...
  const handleNovoRegistro = async () => {
    ...
    try {
      ...
      console.error("[ConselhoProfessor] Erro ao salvar:", err);
  ...
  const handleEditar = async (id) => {
    ...
    try {
      ...
      console.error("[ConselhoProfessor] Erro ao editar:", err);
  ...
  // Foto com LGPD: se o backend retornou null→ mostra iniciais
