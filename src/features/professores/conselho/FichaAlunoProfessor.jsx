...
// - Mesmo layout visual de FichaAlunoConselho (direção/coordenação)
...
// - Card Relatório Disciplinar: visual idêntico, mas NÃO clicável (restrito)
// ============================================================================
      ...
      <div className="fap-wrap" style={{ fontFamily: "'Inter','Segoe UI',sans-serif" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.875rem" }}>
            ...
            {/* Card Disciplinar — visual idêntico, SEM clique (acesso restrito ao professor) */}
            <div
              style={{
            ...
            >
              ...
              {ocorrenciasTotal === null ? (
                <div style={{ display: "flex", alignItems: "center", gap: "0.4rem", color: "rgba(255,255,255,0.5)", fontSize: "0.75rem" }}>
                  <div style={{ width: 12, height: 12, borderRadius: "50%", border: "2px solid rgba(255,255,255,0.2)", borderTop: "2px solid #93c5fd", animation: "fap-spin 0.8s linear infinite" }} />
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.35rem", color: "rgba(147,197,253,0.5)", fontSize: "0.73rem", fontWeight: 600 }}>
                <span>🔒</span><span>Acesso restrito à direção</span>
              </div>
            </div>
          </div>
        </div>
