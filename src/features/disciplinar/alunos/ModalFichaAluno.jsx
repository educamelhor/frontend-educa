...
export default function ModalFichaAluno({ open, codigo, onClose }) {
  ...
  const handleAbrirRelatorio = () => setModalRelatorioOpen(true);
  ...
  return (
    <>
      {/* Ficha — oculta enquanto o Relatório Disciplinar estiver aberto */}
      {!modalRelatorioOpen && (
        <div
          style={{
            position: 'fixed',
                ...
                <>
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
                      {[
                        ...
                        <div key={label}>
                          <div style={{ fontSize: 10, fontWeight: 600, color: '#9ca3af', letterSpacing: '0.08em', marginBottom: 4 }}>
                            {label}
                          </div>
                  ...
                  <div>
                    ...
                    <div
                      ...
                      role="button"
                      tabIndex={0}
                      onKeyDown={e => e.key === 'Enter' && handleAbrirRelatorio()}
                      style={{
                      ...
                      onMouseEnter={e => {
                        ...
                        e.currentTarget.style.boxShadow = '0 8px 20px rgba(15,40,71,0.25)';
                      }}
                      onMouseLeave={e => {
                        e.currentTarget.style.transform = 'translateY(0)';
                        e.currentTarget.style.boxShadow = '0 2px 8px rgba(15,40,71,0.15)';
                      }}
                    >
      ...
      {/* Modal do Relatório Disciplinar — sem sobreposição com a ficha */}
      {aluno && (
