...
// ============================================================
// FICHA DO ESTUDANTE — Módulo PROFESSORES (isolado)
// ✅ Relatório Pedagógico: cria/edita/exclui APENAS SEUS próprios registros
//    Visualiza registros de outros professores (somente leitura)
// ❌ Removidos: Relatório Disciplinar, Upload de Foto
// ============================================================
...
export default function FichaAlunoProfessor({ codigo: codigoProp }) {
  ...
  // ID do professor logado — usado para rastreabilidade de autoria
  ...
  return (
    <div style={{ fontFamily: "'Inter', 'Segoe UI', sans-serif" }}>
      {/* ── HEADER ───────────────────────────────────────────────── */}
      <div style={{
        background: 'linear-gradient(135deg, #4c1d95 0%, #5b21b6 60%, #7c3aed 100%)',
        ...
        <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.55)', marginBottom: 12, display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          FICHA DO ESTUDANTE — PROFESSORES
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <div style={{ flexShrink: 0 }}>
            {fotoURL ? (
              ...
              <div style={{ width: 64, height: 64, borderRadius: '50%', background: 'linear-gradient(135deg, #8b5cf6, #4c1d95)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22, fontWeight: 700, color: '#fff', border: '3px solid rgba(255,255,255,0.3)', letterSpacing: '-1px' }}>
                {iniciais}
              </div>
            )}
          </div>
      ...
      <div style={{ background: '#fff', borderRadius: '0 0 16px 16px', padding: '20px 24px 24px' }}>
        ...
        {/* Nota informativa de autoria */}
        <div style={{ marginBottom: 16, padding: '10px 14px', background: '#faf5ff', border: '1px solid #d8b4fe', borderRadius: 10, color: '#6b21a8', fontSize: 12 }}>
          📝 Você pode criar, editar e excluir seus próprios registros. Os registros de outros professores são somente leitura.
        </div>

        {/* Relatório Pedagógico — apenas pedagogico, com controle de autoria */}
        <div>
          ...
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #4c1d95 0%, #5b21b6 100%)', borderRadius: 14, padding: '18px 20px', cursor: 'pointer', transition: 'transform 0.15s, box-shadow 0.15s', boxShadow: '0 2px 8px rgba(76,29,149,0.15)' }}
            onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 8px 20px rgba(76,29,149,0.25)'; }}
            onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 2px 8px rgba(76,29,149,0.15)'; }}
          >
            <div style={{ fontSize: 22, marginBottom: 8 }}>📋</div>
            <div style={{ fontSize: 14, fontWeight: 700, color: '#fff', marginBottom: 4 }}>Meus Registros Pedagógicos</div>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.7)', marginBottom: 10 }}>Registros do aluno — você edita apenas os seus.</div>
      ...
      {/* Modal pedagógico com controle de autoria por usuarioLogadoId */}
