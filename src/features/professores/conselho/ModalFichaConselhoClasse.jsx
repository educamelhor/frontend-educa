...
// ============================================================================
// Modal de registros do Conselho de Classe — perfil PROFESSOR
//
// Abre via EyeIcon na tabela de alunos do ConselhoClasseProfessor.
//
// Regra LGPD de foto:
...
//
// Este arquivo é EXCLUSIVO do módulo professores/conselho.
...
export default function ModalFichaConselhoClasse({ open, aluno, turma, onClose }) {
  ...
  const fetchRegistros = async () => {
    ...
    try {
      ...
      console.error("[ConselhoProfessor] Erro ao carregar registros:", err);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleNovoRegistro = async () => {
    ...
    try {
      ...
      console.error("[ConselhoProfessor] Erro ao salvar registro:", err);
  ...
  const handleEditar = async (id) => {
    ...
    try {
      ...
      console.error("[ConselhoProfessor] Erro ao editar registro:", err);
  ...
  // ── Foto com LGPD ────────────────────────────────────────────────────────
  // Backend retorna foto=null quando não há consentimento de imagem.
  // Se chegar null (ou der erro de carregamento), exibimos as iniciais.
